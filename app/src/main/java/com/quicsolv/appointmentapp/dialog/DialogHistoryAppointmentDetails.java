...
public class DialogHistoryAppointmentDetails extends Dialog implements
    ...
    public DialogHistoryAppointmentDetails(Activity a, _3 param) {
        super(a);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_history_appointment_details);
